...
(defn solutions []
  (doall
   [(time (exercise1 core/org-repo-users))
    (time (exercise2 core/org-repo-users :user2))
    (time (exercise2 core/org-repo-users :user3))
    (time (exercise2 core/org-repo-users :user1))
    (time (exercise3 core/org-repo-users))]))
